...
class SatMqttCoordinator(SatDataUpdateCoordinator):
    ...
    def flame_active(self) -> bool:
        return bool(self._get_entity_state(BINARY_SENSOR_DOMAIN, DATA_FLAME_ACTIVE)) == DeviceState.ON

    @property
    def hot_water_active(self) -> bool:
        return bool(self._get_entity_state(BINARY_SENSOR_DOMAIN, DATA_DHW_ENABLE)) == DeviceState.ON
