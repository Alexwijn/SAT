...
def create_minimum_setpoint_controller(config_options) -> MinimumSetpoint:
    adjustment_delay = config_options.get(CONF_MINIMUM_SETPOINT_DELAY_ADJUSTMENT)

    return MinimumSetpoint(adjustment_delay=adjustment_delay)
