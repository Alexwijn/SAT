...
class SatBinarySensor(SatEntity, BinarySensorEntity):
    ...
    def __init__(
        ...
        self.entity_id = async_generate_entity_id(
            ENTITY_ID_FORMAT, f"{config_entry.data.get(CONF_NAME)}_{source}_{key}", hass=coordinator.hass
        )
    ...
    def unique_id(self):
        ...
        return f"{self._config_entry.data.get(CONF_NAME)}-{self._source}-{self._key}"
...
class SatControlSetpointSynchroSensor(SatEntity, BinarySensorEntity):
    ...
    def unique_id(self):
        """Return a unique ID to use for this entity."""
        return f"{self._config_entry.data.get(CONF_NAME)}-control-setpoint-synchro"
...
class SatCentralHeatingSynchroSensor(SatEntity, BinarySensorEntity):
    ...
    def unique_id(self):
        """Return a unique ID to use for this entity."""
        return f"{self._config_entry.data.get(CONF_NAME)}-central-heating-synchro"
